...
${DOCKER_CMD} run --rm -e GOPROXY=${GOPROXY} -v $(pwd):/opt/workspace -w /opt/workspace/cmd/did-method-rest golangci/golangci-lint:v1.21 golangci-lint run -c ../../.golangci.yml
